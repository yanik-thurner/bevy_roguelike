...
pub fn sync_cam_system(mut camera: Query<&mut Transform, (With<PlayerCamera>, Without<Player>)>, player_transform: Query<&Transform, (With<Player>, Without<PlayerCamera>, Without<Animation>)>) {
